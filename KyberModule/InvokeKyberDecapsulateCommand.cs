...
{
    /// <summary>
    /// Cmdlet pour décapsuler une clé partagée avec une clé privée Kyber
    /// </summary>
    [Cmdlet(VerbsLifecycle.Invoke, "KyberDecapsulate")]
    [OutputType(typeof(KyberDecapsulationResult))]
    public class InvokeKyberDecapsulateCommand : PSCmdlet
    {
        [Parameter(
            Mandatory = true,
            Position = 0,
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                // Décapsuler
                byte[] sharedSecret = kyber.Decapsulate(ciphertextBytes, privateKeyBytes);
            ...
            {
                WriteError(new ErrorRecord(ex, "KyberDecapsulationError", ErrorCategory.NotSpecified, null));
            }
        }
    }
    ...
    /// </summary>
    public class KyberDecapsulationResult
    {
