...
{
    /// <summary>
    /// Cmdlet pour vérifier une signature Dilithium
    /// </summary>
    [Cmdlet(VerbsDiagnostic.Test, "DilithiumSignature")]
    [OutputType(typeof(bool))]
    public class TestDilithiumSignatureCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                if (PreHash.IsPresent)
                {
                    ...
                    isValid = dilithium.VerifyWithSHA3(dataBytes, signatureBytes, publicKeyBytes, sha3Variant);
                }
                else
                {
                    // Vérifier sans pré-hachage
                    isValid = dilithium.Verify(dataBytes, signatureBytes, publicKeyBytes, false);
                }
            ...
            {
                WriteError(new ErrorRecord(ex, "DilithiumVerifyError", ErrorCategory.NotSpecified, null));
            }
        }
